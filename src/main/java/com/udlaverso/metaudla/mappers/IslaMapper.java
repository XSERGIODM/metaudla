...
public interface IslaMapper {
    ...
    @Mapping(target = "categoriaIds", expression = "java(categoriasToCategoriaIds(isla.getCategorias()))")
    ...
    default List<Long> categoriasToCategoriaIds(List<Categoria> categorias) {
